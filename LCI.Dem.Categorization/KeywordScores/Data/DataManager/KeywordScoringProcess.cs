...
namespace KeywordScoring.Data.DataManager
{
    public class KeywordScoringProcess : DbFactoryBase, IKeywordScoringProcess
    {
        ...
        public IEnumerable<DocketEventScore> GetDocketEventScore()
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketEventScore>(sqlQuery);
        ...
        public IEnumerable<DocketKeywordScore> GetDocketKeywordScore()
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketKeywordScore>(sqlQuery);
        ...
        public IEnumerable<int> GetEventID()
        {
            //_logger.LogInformation($"GetDocketKeywordScore - Start");
            ...
            try
            {
                ...
                var response = DbConnection.Query<int>(sqlQuery);
        ...
        public IEnumerable<DocketKeywordScoreComplete> GetDocketKeywordScoreComplete()
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketKeywordScoreComplete>(sqlQuery);
        ...
        public IEnumerable<DocketScoringStatus> GetDocketScoringStatus()
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketScoringStatus>(sqlQuery);
        ...
        public IEnumerable<EventKeywordMaster> GetEventKeywordMasterLevel3(string sThreadName)
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<EventKeywordMaster>(sqlQuery);
        ...
        public IEnumerable<EventKeywordMaster> GetEventKeywordMasterLevel012(string sThreadName)
        {
            _logger.LogInformation($"GetEventKeywordMaster - Start " + sThreadName);
        ...
        public IEnumerable<EventKeywordMaster> GetEventKeywordMasterLevel101100(string sThreadName)
        {
        ...
        public IEnumerable<EventMaster> GetEventMaster(int regularEvent, string sThreadName)
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<EventMaster>(sqlQuery, param);
        ...
        public IEnumerable<DocketScoringStatus> GetDocketEntriesToBeProcessed(string jobIdNum, int inProgressStatus)
        {
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketScoringStatus>(sqlQuery, param);
        ...
        public int ExecuteProcedureCreateDocketKeywordScoreByLevels(string jobIdNum,int batchID)
        {
            ...
            try
            {
                ...
                var result = DbConnection.Execute(StoreProcedure.CreateDocketKeywordScoreByLevels,param, commandType: System.Data.CommandType.StoredProcedure, commandTimeout: 0);
        ...
        public IEnumerable<DocketKeywordScoreCompleteEventKeywordMaster> GetTimeTakenByKeyword()
        {
            //_logger.LogInformation($"GetDocketEventScore - Start");
            ...
            try
            {
                ...
                var response = DbConnection.Query<DocketKeywordScoreCompleteEventKeywordMaster>(sqlQuery);
